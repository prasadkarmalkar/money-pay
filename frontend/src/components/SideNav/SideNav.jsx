  ...
  return (
    <div className='bg-white h-screen py-14 min-w-52 rounded-tr-3xl rounded-br-3xl'>
        ...
        <nav className='mt-10'>
            ...
            <div className='flex items-center gap-2 font-bold p-2 rounded-xl cursor-pointer  ml-4 w-full my-2 z-10 relative'><RiLogoutCircleLine  className='text-2xl'/> Logout</div>
        </nav>
    </div>
  )
}
